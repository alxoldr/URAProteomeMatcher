...
def main(args):
    ...
    # find values for exact, group, and best match columns
    ...
    for index, row in proteome_data.iterrows():
        ...
        ur_group_matches = matcher.get_ur_group_matches(index, group_data, genes)
    ...
    matcher.write_dataframe_file(updated_proteome_data, out_file)
    return out_file
...
def ui_main():
    ...
    pd_button = create_button(frame, 'Select Proteome File', get_file_path, pd_entry)
